...
dns_hosts = {
    b"itmix.gr.": "192.168.22.7",
    b"google.com.": "192.168.22.7",
...
# make it run in combination with arp spoofer
...
# iptables --append FORWARD --match string --algo kmp --hex-string '|c0 a8 16 10|' --jump DROP
# iptables --append FORWARD --match string --algo kmp --hex-string '|c0 a8 16 0f|' --jump DROP
